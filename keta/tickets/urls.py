...
from tickets.views import (
    JcanalesrecepcionesViewSet,
    JclasestarjetasViewSet,
    JtiposproductosViewSet,
    JconceptosViewSet,
    JmarcastarjetasViewSet,
    JprioridadesViewSet,
    JtipostarjetasViewSet,
    JtarjetasViewSet,
    JtiposcomentariosViewSet,
    JtickettiposViewSet,
    JtipostransaccionesViewSet,
    JproblemasViewSet,
...
urlpatterns = [
    ...
    path(
        "tiposproductosconceptos/<int:idtipoproducto>/",
        JtiposproductosJconceptosListView.as_view(),
        name="tiposproductosconceptos",
    ),
]
